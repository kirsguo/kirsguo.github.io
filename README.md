...
###[View Live Kirsguo Blog ;](https://kirsguo.github.io)
...
```
# Site settings
title: Kirsguo Blog             # title of your website
SEOTitle: Kirsguo Blog			# check out docs for more detail
# SNS settings      
github_username: kirsguo     # modify this account to yours
weibo_username: kirsguo      # the footer woule be auto-updated.
